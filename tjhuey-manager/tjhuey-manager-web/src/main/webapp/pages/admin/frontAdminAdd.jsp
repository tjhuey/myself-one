	...
	<div id="myTabContent" class="tab-content">
		<div class="tab-pane fade in active" id="userAddOne">
			<form role="form" id="myForm">
				<input type="hidden" name="authority" value="2"><br>
				<div class="div2">
					<!-- 账号 -->
...
<!-- 										<option value="辽宁省">辽宁省</option> -->
					...
					<div class="col-xs-6 div3">
						<div class="form-group div4-left">
							...
							<div class="div5-right">
								<input style="width: 96%;" type="text" class="form-control"
									id="detail" name="detail" placeholder="请输入区县详细地址"
									required="required">
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	$("#province").change(function() {
		...
		if (province == '辽宁省') {
			$("#city").empty();
			$("#city").append("<option value='大连市'>大连市</option>");
			$("#city").append("<option value='沈阳市'>沈阳市</option>");
			$("#city").append("<option value='本溪市'>本溪市</option>");
			$("#city").append("<option value='鞍山市'>鞍山市</option>");
		}
	});
